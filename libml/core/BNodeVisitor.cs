...
namespace ml.core
{
	class BNodeVisitor
	{
		...
		public void VisitTree(IMLNode root, Func<IMLNode, int, bool> callback)
		{
		...
		private void VisitTreeInternal(IMLNode root, Func<IMLNode, int, bool> callback, int depth)
		{
			if (stopVisiting)
			{
				return;
